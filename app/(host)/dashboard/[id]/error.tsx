...
export default function DashboardListingError({
  error,
  reset,
}: {
  ...
  return (
    <main className="max-w-screen-xl mx-auto px-6 py-24 flex flex-col items-center text-center gap-6">
      ...
      <div>
        <h2 className="text-lg font-bold text-foreground">Could not load this listing</h2>
        <p className="mt-1.5 text-sm text-muted-foreground">
          The listing may not exist or you may not have permission to manage it.
        </p>
      </div>
      <button
        onClick={reset}
