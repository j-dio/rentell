...
export default function VisitsManageError({
  error,
  reset,
}: {
  ...
  return (
    <main className="max-w-screen-xl mx-auto px-6 py-24 flex flex-col items-center text-center gap-6">
      ...
      <div>
        <h2 className="text-lg font-bold text-foreground">Could not load visit requests</h2>
        <p className="mt-1.5 text-sm text-muted-foreground">
          The database is waking up or this listing could not be found. Please try again.
        </p>
      </div>
      <button
        onClick={reset}
